	...
	<table width="74%" border="0" cellpadding="0" cellspacing="0" bordercolor="#99CC99" align="center">
	  ...
	  <tr>
	    ...
	    <ol>
          ...
          (<strong>Bank BRI No.502.20.22304.6, a/n Apip Saleh</strong>)          </font></li>
	      ...
	      <li><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Kemudian kirim ke alamat <strong>suherman@yahoo.com</strong>. dengan <em>Subject:</em><strong>Pesanan <? echo $_GET['kode'];?></strong></font></li>
